...
const SkillCard = ({ authorEmail, category, createdAt, description,
  installCommand, tags, title }: SkillRecord) => {
    ...
    <article className="skill-card">
      ...
      <div className="body">
        ...
        <div className="command">
          ...
          <button type="button" className="copy" onClick={handleCopy} aria-label={`Copy command for ${title}`}>
